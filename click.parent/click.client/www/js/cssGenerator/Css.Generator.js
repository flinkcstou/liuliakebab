...
var css = {
  ...
  transferNewCardInputFields: ".transfer-new-card-input-fields" +
  "{" +
  "position: absolute;" +
  "height:" + 345 * widthK + "px;" +
  "width:" + 607 * widthK + "px;" +
  ...
  transferNewCardNumberInputContainerBottomShadow: ".transfer-new-card-number-input-container-bottom-shadow" +
  "{" +
  "border: none;" +
  "outline: none;" +
  "position: absolute;" +
  ...
  "left:" + 28 * widthK + "px;" +
  "width:" + 547 * widthK + "px;" +
  "height:" + 31.25 * widthK + "px;" +
  "background-image: url('resources/icons/ViewTransfer/input_bottom_shadow.png');" +
  "background-repeat: no-repeat;" +
  "background-size: cover;" +
  "z-index: 2;" +
  "margin: 0;" +
  ...
  transferNewContactFoundContainerReduce: ".transfer-new-card-input-fields-reduce .transfer-new-card-found-container" +
  "{" +
  "position: relative;" +
  "width: 90%;" +
  "height:" + 100 * widthK + "px;" +
...
//"height:" + 1150 * widthK + "px; " +
  ...
  // "width: 100%;" +
  // "margin: 0 auto 3% auto;" +
  // // "padding-bottom: " + 80 * widthK  + "px;" +
  // "height: auto; " + // 415 * widthK + "px;" +
  // //"contain: content;" +
  // // "background-image: url('resources/icons/ViewNews/news.png');" +
  // // "background-repeat: no-repeat;" +
  // // "background-position-y: bottom;" +
  ...
  viewNewsItemIconMore: ".view-news-item-icon-more" +
  "{" +
  "width:" + 40 * widthK + "px; " +
  "height:" + 40 * heightK + "px; " +
  ...
  // "}",
  //
  // viewNewsBlockFooter: ".view-news-block-footer " +
  // "{" +
  // "position: absolute;" +
  // "width: 100%;" +
  // "height: " + 80 * widthK  + "px;" +
