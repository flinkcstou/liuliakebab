...
//      console.log(onTouchEndY)
    ...
    //
    //                        if (bool) {
    //                          scope.serviceList[index]['icon'] = cordova.file.dataDirectory + fileName;//
    //                        } else {
    //                          scope.serviceList[index]['icon'] = cordova.file.applicationDirectory + 'www/resources/icons/ViewPay/service/' + fileName;
    ////                        alert("new icon=" + scope.categoryList[index]['icon']);
    //                        }
    //
    ...
    //                            console.log("obj id=", scope.serviceList[index].id);
    ...
    //                            console.log("obj id 2=", scope.serviceList[index].id);
    ...
    //                          scope.servicesMapByCategory[object.category_id].push(scope.serviceList[index]);
    //                        }
    //                        else {
    //                          scope.servicesMapByCategory[object.category_id].push(scope.serviceList[index]);
    //                        }
