<view-registration-device-new class="view-registration-device riot-tags-main-container">
  ...
  <script>
    ...
    //    <p class="registration-device-phone-input">+{window.languages.CodeOfCountry}</p>
    //    <input class="registration-device-phone-input"
    //    type="tel"
    //    id="firstFieldInput"
...
//          this.rememberIcon.style.opacity = '0.3';
    ...
    history.arrayOfHistory.push(
      {
        "view": 'view-registration-device-new',
        "params": opts
      }
    );
