<view-transfer-by-phone class="riot-tags-main-container">
  ...
  <script>
    ...
    this.titleName = window.languages.ViewPayTransferByPhoneNumberTitle;
    var scope = this;
