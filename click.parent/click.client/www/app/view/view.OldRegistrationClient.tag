<view-registration-client class="view-registration-client">
    ...
    <div class="registration-client-card-field">
        ...
        <div id="cardNumberInput" class="registration-client-card-number" type="text">
            <input onclick="onFocusOfInput()" ontouchend="touchEndBoxOne()" id="boxOne" type="text" maxlength="4"
        ...
        <div id="cardPinInput" class="registration-client-card-pin" type="text">
            ...
            <input id="boxPin" type="text" maxlength="14"
    ...
    <div class="registration-keyboard-field keyboard-field">
        <div class="registration-button-help" ontouchend="registration()">Помощь</div>
    ...
    <script>
        ...
        componentKeyboard.returnValue = function (myValue) {
            ...
            if (myValue != 'x') {
                ...
                if (boxData.value.length < 6 && boxData.autofocus) {
...
//          console.log('selection start ', scope.boxThree.selectionStart);
            ...
            if (cardNumberPartOne == '8600' && cardNumberPartOne.length == 4) {
                cardPinInput.style.display = 'none';
                cardDateInput.style.display = 'block';
            }
            else if (cardNumberPartOne != '8600' && cardNumberPartOne.length == 4) {
                cardDateInput.style.display = 'none';
        ...
        registration = function () {
            ...
            riot.mount('view-pin-code',[cardNumber, cardData]);
        }
    </script>
