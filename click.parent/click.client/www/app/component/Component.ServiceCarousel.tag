<component-service-carousel>
  <div id="containerService" class="service-carousel" ontouchstart="touchStartService()"
    ...
    <component-service style="left: 320px"></component-service>
  </div>
  ...
  <script>
    ...
    changePosition = function () {
      if (touchEndX < touchStartX) {
        this.containerService.style.transform = "translate3d(-270px, 0, 0)";
        this.containerService.style.webkitTransform = "translate3d(-270px, 0, 0)";
